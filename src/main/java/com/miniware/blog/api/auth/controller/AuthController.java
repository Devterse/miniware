...
public class AuthController {
    ...
    //로그인
    @PostMapping("/login")
    public ResponseEntity<ResponseDto<AuthResponse>> login(@Valid @RequestBody AuthRequest request) {
    ...
    @PostMapping("/refresh")
    public ResponseEntity<ResponseDto<AuthResponse>> refreshToken(@RequestBody RefreshRequest request) {
    ...
    //로그아웃
    @PostMapping("/logout")
    public ResponseEntity<ResponseDto<Void>> logout(@RequestBody RefreshRequest request) {
